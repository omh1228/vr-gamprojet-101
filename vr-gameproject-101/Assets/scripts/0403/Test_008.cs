...
using UnityEngine;
using UnityEngine.UI;                                                   //UI에 접군하기 위해서 사용
public class Player
{
...
{
    Player Player_01 = new Player();                                 //위에 만든 플레이어 클래스를 선언한다.(전역게 사용하기 위해서)
    Player Player_02 = new Player();                                 //위에 만든 플레이어 클래스를 선언한다.(전역게 사용하기 위해서)
